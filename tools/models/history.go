...
var (
	...
	historyColumnsWithoutDefault = []string{}
	historyColumnsWithDefault    = []string{"id", "anime_id", "platform", "type", "title", "updated_at", "created_at"}
	historyPrimaryKeyColumns     = []string{"id"}
	historyGeneratedColumns      = []string{"id", "anime_id", "platform", "type", "title", "updated_at", "created_at"}
)
